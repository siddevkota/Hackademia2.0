...
from .models import Course, Lecture, Section, LectureComment, AIContent, Quiz
...
class AIContentInlineAdmin(admin.TabularInline):
    model = AIContent
    extra = 1
...
# admin.site.register(AIContent, AIContentInlineAdmin)\
